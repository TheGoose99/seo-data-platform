...
/** CloseBy Hero A — split layout, blob image (matches closeby-components hero-a). */
export function HeroA({ config }: { config: ClientConfig }) {
  return (
    <section
      id="cb-section-hero"
      data-cb-variant="a"
      className="hero-a min-h-svh pt-16 pb-0 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center max-w-[1200px] mx-auto px-6 lg:px-10 bg-cream"
    >
      <div className="pt-8 lg:pt-0 order-2 lg:order-1 text-center lg:text-left">
          ...
          >
            {config.images.therapist ? (
              ...
              <div className="w-full h-full flex flex-col items-center justify-center gap-3 text-sage-d">
                <svg width="72" height="72" viewBox="0 0 64 64" fill="none" className="opacity-30">
